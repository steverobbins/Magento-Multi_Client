...
class Multi_Client_Log_Formatter extends Zend_Log_Formatter_Abstract
{
    /**
     * Factory for Multi_Client_Log_Formatter class
     *
     * @param  array|Zend_Config $options
     * @return Multi_Client_Log_Formatter
     */
    ...
    public function format($event)
    {
        return $this->color($event['timestamp'])->dark_gray()
            . str_repeat(' ', 7 - strlen($event['priorityName'])) . '[' . $this->priorityColor($event['priorityName'], $event['priority']) . '] '
